...
def Hash(stringh, salt, sharounds):
    ...
    for i in range(16):
        try:
            if i == 1:
                CharacterHash1 = hex(int(ord(stringh[i])))
            if i == 2:
                CharacterHash2 = hex(int(ord(stringh[i])))
            if i == 3:
                CharacterHash3 = hex(int(ord(stringh[i])))
            if i == 4:
                CharacterHash4 = hex(int(ord(stringh[i])))
            if i == 5:
                CharacterHash5 = hex(int(ord(stringh[i])))
            if i == 6:
                CharacterHash6 = hex(int(ord(stringh[i])))
            if i == 7:
                CharacterHash7 = hex(int(ord(stringh[i])))
            if i == 8:
                CharacterHash8 = hex(int(ord(stringh[i])))
            if i == 9:
                CharacterHash9 = hex(int(ord(stringh[i])))
            if i == 10:
                CharacterHash10 = hex(int(ord(stringh[i])))
            if i == 11:
                CharacterHash11 = hex(int(ord(stringh[i])))
            if i == 12:
                CharacterHash12 = hex(int(ord(stringh[i])))
            if i == 13:
                CharacterHash13 = hex(int(ord(stringh[i])))
            if i == 14:
                CharacterHash14 = hex(int(ord(stringh[i])))
            if i == 15:
                CharacterHash15 = hex(int(ord(stringh[i])))
            if i == 16:
                CharacterHash16 = hex(int(ord(stringh[i])))
        except: pass
